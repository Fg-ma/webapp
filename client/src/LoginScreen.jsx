        ...
        <div className="w-screen h-screen flex py-24 px-60">
            ...
            <div className="pl-20 w-5/12 h-full flex flex-col space-y-4">
                <div className="flex flex-col items-center justify-center border border-fg-white-65 rounded h-3/4 p-12 w-full">
                    ...
                    <input className="text-xl font-K2D h-12 w-full rounded bg-fg-white-95 mb-4 pl-4" placeholder="Username, email, or phone number" type="text" value={username} onChange={(e) => setUsername(e.target.value)} />
                    <input className="text-xl font-K2D h-12 w-full rounded bg-fg-white-95 mb-4 pl-4" placeholder="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                    ...
                    <div className="w-full px-10">
                        ...
                        <div className="text-2xl font-K2D h-14 w-full rounded-full bg-fg-primary text-white p-1 cursor-pointer" onClick={handleLogin}>
                            <div className="bg-white rounded-full w-full h-full p-0.5">
                ...
                <div className="flex flex-col items-center justify-center border border-fg-white-65 rounded h-1/4 px-12 pt-3 pb-4">
                    ...
                    <div className="w-full px-10">
                        <button className="border-2 border-fg-primary rounded-full h-14 w-full text-2xl font-K2D cursor-pointer" onClick={handleCreateAccount} >Create an account</button>
                    </div>
                </div>
            </div>
        </div>
