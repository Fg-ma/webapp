...
export default function ContentPage({ contentType }) {
    ...
    if (contentType == "sheets") {
        content_id = useSelector(
            (state) => state.page.main.pagePayload.ids.sheet_id
        );
    } else if (contentType == "videos") {
        content_id = useSelector(
            (state) => state.page.main.pagePayload.ids.video_id
        );
    } else if (contentType == "images") {
        content_id = useSelector(
            (state) => state.page.main.pagePayload.ids.image_id
        );
    }
