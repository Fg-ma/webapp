...
const middleAdvancedSearchFilterVar: Variants = {
  init: {
    y: "25%",
    opacity: 0,
  },
...
export default function MiddleSearchFilter({ refs }: MiddleSearchFilterProps) {
  ...
  */
  ...
  const filterFormData = useSelector(
    (state: MiddleFilterState) => state.filters.middle.filterPayload,
  );
  const [
    middleAdvancedSearchFilterVisible,
    setMiddleAdvancedSearchFilterVisible,
  ] = useState(false);
  ...
  const middleAdvancedSearchFilterContainerRef = useRef<HTMLDivElement>(null);
  refs.middleAdvancedSearchFilterContainer =
    middleAdvancedSearchFilterContainerRef;
  ...
  function handleFilterFormChange(event: ChangeEvent<HTMLInputElement>) {
    ...
    dispatch(
      setFilterOption("middle", name, type === "checkbox" ? checked : value),
    );
  }
  ...
  return (
    <div
      ref={refs.middleSpaceFilter}
      className="w-full bg-white rounded-md mt-2 shadow-md"
    >
      <form className="flex h-full p-4">
        <div
          className="bg-white flex flex-col pr-6 justify-between"
          style={{ width: "55%" }}
        >
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <div className="flex items-center">
                ...
                >
                  <Checkbox
                    checked={filterFormData.isWhatsCurrent}
                    hovering={hovering.middleIsWhatsCurrent}
                  />
              ...
              <div className="flex items-center">
                ...
                >
                  <Checkbox
                    checked={filterFormData.isAffiliateActivity}
                    hovering={hovering.middleIsAffiliateActivity}
                  />
                  <span className="text-base ml-2 font-K2D">
                    Affiliate Activity
                  </span>
              ...
              <div className="flex items-center">
                ...
                >
                  <Checkbox
                    checked={filterFormData.isAllTimeGreats}
                    hovering={hovering.middleIsAllTimeGreats}
                  />
                  <span className="text-base ml-2 font-K2D">
                    All Time Greats
                  </span>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  >
                    <Checkbox
                      checked={filterFormData.isDatePosted}
                      hovering={hovering.middleIsDatePosted}
                    />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  >
                    <Checkbox
                      checked={filterFormData.isPopularity}
                      hovering={hovering.middleIsPopularity}
                    />
        ...
        <div
          ref={middleAdvancedSearchFilterContainerRef}
          className="flex justify-center items-center"
          style={{ width: "45%", maxWidth: "45%" }}
        >
          <AnimatePresence
            onExitComplete={() => {
              setMiddleAdvancedSearchFilterVisible(false);
            }}
          >
            {filterFormData.isAdvancedSearch && (
              <motion.div
              ...
              >
                <MiddleAdvancedSearchFilter
                  ...
                  refs={{
                    middleAdvancedSearchFilterContainer:
                      refs.middleAdvancedSearchFilterContainer,
