...
export default function MiddleSearchFilter({ refs }) {
    ...
    */
    ...
    const filterFormData = useSelector(
        (state) => state.filters.middle.filterPayload
    );
    const [
                        ...
                        <div className='flex flex-col space-y-3'>
                            ...
                            <div className='flex items-center'>
                                ...
                                >
                                    <Checkbox
                                        checked={
                                            filterFormData.isAffiliateActivity
                                        }
                                        hovering={
                                            hovering.middleIsAffiliateActivity
                                        }
                                    />
                                    <span className='text-base ml-2 font-K2D'>
                                        Affiliate Activity
                            ...
                            <div className='flex items-center'>
                                ...
                                >
                                    <Checkbox
                                        checked={filterFormData.isAllTimeGreats}
                                        hovering={
                                            hovering.middleIsAllTimeGreats
                                        }
                                    />
                                    <span className='text-base ml-2 font-K2D'>
                                        All Time Greats
                                ...
                                {filterFormData.isDatePosted && (
                                    <label className='switch'>
                                        <input
                                            ...
                                            checked={
                                                filterFormData.isDatePostedSwitched
                                            }
                                            onChange={handleFilterFormChange}
                                        />
                                        ...
                                        <div className='inline w-40'>
                                            <div className='inline-block w-1/2 text-center'>
                                                <span className='middleLabelText newest'>
                                                    Newest
                                                </span>
                                            </div>
                                            <div className='inline-block w-1/2 text-center'>
                                                <span className='middleLabelText oldest'>
                                                    Oldest
                                                </span>
                                            </div>
                                        </div>
                                ...
                                {filterFormData.isPopularity && (
                                    <label className='switch'>
                                        <input
                                            ...
                                            checked={
                                                filterFormData.isPopularitySwitched
                                            }
                                            onChange={handleFilterFormChange}
                                        />
                                        <span className='slider round'></span>
                                ...
                                <MiddleAdvancedSearchFilter
                                    ...
                                    refs={{
                                        middleAdvancedSearchFilterContainer:
                                            refs.middleAdvancedSearchFilterContainer,
                                        middleAdvancedSearchFilter:
                                            refs.middleAdvancedSearchFilter,
