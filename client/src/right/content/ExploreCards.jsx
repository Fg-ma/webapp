    ...
    */
    ...
    const exploreCards = explore.map(exploreInfo => {
        switch (exploreInfo.cardType) {
            case "issue":
                return <NewsCard key={exploreInfo.id} title={exploreInfo.title} subject={exploreInfo.issueQuestions} affResponses={exploreInfo.affResponses} />;
            case "individual":
            ...
            case "organization":
                return <OrganizationCard key={exploreInfo.id} name={exploreInfo.name} subject={exploreInfo.currentIssue} stances={exploreInfo.stances} />;
            default:
