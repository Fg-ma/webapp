                                ...
                                <div className='flex items-center'>
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            hovering={
                                                hovering.rightIsAffiliateActivity
                                            }
                                        />
                                        <span className='text-base ml-2 font-K2D'>
                                            Affiliate Activity
                                ...
                                page === "papers" ? (
                                    <div className='flex items-center'>
                                        <input
                                            ...
                                            className='hidden'
                                            checked={
                                                filterFormData.isAllTimeGreats
                                            }
                                            onChange={handleFilterFormChange}
                                        />
                                        <motion.label
                                        ...
                                        <label className='switch'>
                                            ...
                                            <div className='inline w-40'>
                                                <div className='inline-block w-1/2 text-center'>
                                                    <span className='rightLabelText newest'>
                                                        Newest
                                                    </span>
                                                </div>
                                                <div className='inline-block w-1/2 text-center'>
                                                    <span className='rightLabelText oldest'>
                                                        Oldest
                                                    </span>
                                                </div>
                                            </div>
